            ...
            function getShotgunObj(evt)
                {
                    ...
                    sg_info_text = sg_search_panel.add("statictext", undefined, "",{multiline:true});
                     ...
                     sg_bg_lists =  sg_search_panel.add("listbox", undefined, "BG layers list", {multiselect:false});
                        sg_bg_lists.preferredSize = [350,250];
                    ...
                    sg_results_list = sg_search_panel.add("listbox", undefined, "BG layers list", {multiselect:false});
                     sg_results_list.preferredSize = [350,250];
            ...
            function loadcurrentEpisodeAsset (evt)
                {
					...
					{
						var name = episode_assets_list[obj].name;
						assets_sorted.push(name);
						assets_dict[name] = episode_assets_list[obj];
					}
					assets_sorted.sort()
					
                    // populate bg_list
                    for (var i in assets_sorted)
					{
						var ass_name = assets_sorted[i];
						item = bg_list.add("item", ass_name);
						item.sg_id = assets_dict[ass_name]['sg_id'];
						item.parent_shots = assets_dict[ass_name]['parentShot'];
					}
