// PROJECT PATHS //
var season = "Season6"; // exact name of actual season's folder on the server
...
/*
	> naming convention template for files stored in LO approved folder:
		GB500EPISODE_Sc000_LO_TYPE.ext
	e.g. : GB500EPISODE_Sc000_LO_MA.ma for the maya file
...
*/
var resolutions_templates = [ "2K","3K","4K","6K" ];
